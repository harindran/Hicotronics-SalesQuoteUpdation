...
Namespace SalesQuoteUpdation
    Public Class clsAddon
        ...
        Public HWKEY() As String = New String() {"W1831256098", "V0913316776", "M0090876837", "Y1334940735", "A0061802481", "T0659980171"}
...
#Region "Menu Creation Details"
        ...
        Private Sub Menu()
            ...
            'CreateMenu("", Menucount, "Quotation", SAPbouiCOM.BoMenuType.mt_POPUP, "Quote", "2304")
            Menucount = 1 'Menu Inside            
            CreateMenu("", Menucount, "Quotation Updation", SAPbouiCOM.BoMenuType.mt_STRING, "OQUT", "2304") : Menucount += 2
        ...
        Public Sub MenuEvent_For_FormOpening(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
            Try
                If pVal.BeforeAction = False Then
                    Select Case pVal.MenuUID
                        Case "OQUT"
                            If Not objaddon.objglobalmethods.FormExist("OQUT") Then
                                Dim activeform As New SalesQuoteUpdate
                                activeform.Show()
                            End If
